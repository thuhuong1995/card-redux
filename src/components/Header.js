            ...
            <header>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a className="waves-effect">Product Page V.2</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Product Page V.3</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a className="waves-effect">Page with contact form</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Page with contact form V.2</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Page with sign in form</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Page with 'terms of use'</a>
                                        </li>
                                        <li>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        <li>
                                            <a className="waves-effect">Ecommerce homepage default</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Ecommerce homepage full
                    width</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Ecommerce homepage V.3
                    Carousel</a>
                                        </li>
                                        <li>
                    ...
                    homepage V.3 Half Page Carousel</a>
                                        ...
                                        <li>
                                            <a className="waves-effect">Ecommerce homepage V.4</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        <li>
                                            <a className="waves-effect">Page with column on the right</a>
                                        </li>
                                        <li>
                    ...
                    on the left</a>
                                        ...
                                        <li>
                                            <a className="waves-effect">Page with newsletter on the
                    right</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Full width page with
                    logged user</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Full width page with not logged user</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        <li>
                                            <a className="waves-effect">Category list with
                    left column</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Category list
                    with right column</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Category grid with
                    left column</a>
                                        </li>
                                        <li>
                                            <a className="waves-effect">Category grid with
